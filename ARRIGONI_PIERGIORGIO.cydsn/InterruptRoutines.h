...
*/
    ...
    #define VALUES_TO_SEND 2 //sampled signals to be sent to the bridge control panel
    #define BUFFER_SIZE 1 + 2*VALUES_TO_SEND + 3 //header byte + 2 bytes for each sampled signals + 2 bytes for light threshold value + tail byte
